...
function consolidateCompsAndFootage() {
  ...
  app.beginUndoGroup("Quick Compact");

  var reduced = app.project.reduceProject(selectedComps);
  var footage = app.project.consolidateFootage();
  var comps = consolidateCompositions();
  var nulls = consolidateSolidsAndNulls();
